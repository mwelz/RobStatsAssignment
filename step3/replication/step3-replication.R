#' ----------------------------------------------------------------
#' Replicate Figure 16 in https://arxiv.org/pdf/1712.05151.pdf
#' 
#' Author: mwelz
...
pdf(file = paste0(getwd(), "/step3/replication/fig16a.pdf"))
...
pdf(file = paste0(getwd(), "/step3/replication/fig16b.pdf"))
