#' ----------------------------------------------------------------
#' Revise Figure 16 in https://arxiv.org/pdf/1712.05151.pdf
...
## 2. save the results ----
save(a.arr.panel1, a.arr.panel2, dcor.arr.panel1, dcor.arr.panel2, dcor.arr.trans.panel1, dcor.arr.trans.panel2, file = paste0(getwd(), "/step3/extension/step3-simdata.Rdata"))
