...
load(paste0(getwd(), "/max/step3/extension/step3-simdata.Rdata"))
...
plot(a.arr.panel1, panel1.classic, type = "l", xlab = "a", ylab = "dCor", main = "dCor of Cauchy data with 1 outlier at (a,a)", ylim = c(0,1))
