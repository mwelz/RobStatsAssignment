#' ----------------------------------------------------------------
#' Visualize a replication of Figure 16 in https://arxiv.org/pdf/1712.05151.pdf
#' 
#' Author: mwelz 
...
load(paste0(getwd(), "/step4/replication/step4-replication-simdata.Rdata"))
...
for(d in d.set){
  ...
  pdf(file = paste0(getwd(),
                    "/step4/replication/plot-fixed-d/plot_d=", d, ".pdf"))
