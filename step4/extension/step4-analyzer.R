#' ----------------------------------------------------------------
#' Analyze the simulation results of revising Figure 8 in https://arxiv.org/pdf/1712.05151.pdf
#' 
#' Author: mwelz 
...
load(paste0(getwd(), "/step4/extension/step4-simdata.Rdata"))
...
for(d in d.set){
  ...
  pdf(file = paste0(getwd(),
                    "/step4/extension/plot-fixed-d/plot_d=", d, ".pdf"))
...
for(n in n.set){
  ...
  pdf(file = paste0(getwd(),
                    "/step4/extension/plot-fixed-n/plot_n=", n, ".pdf"))
